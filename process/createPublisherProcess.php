<?php
    ...
    if(isset($_POST['save'])  && $_SESSION['admin'] == 1){
        ...
        "INSERT INTO publisher(namaPublisher, logo, tanggalBerdiri, keterangan)
        VALUES
        ('$namaPublisher', '$new_img_name', '$tanggalBerdiri', '$keterangan')") 
        or die(mysqli_error($con));

        if($query){
            echo
                '<script>
                alert("Tambah Publisher Success");
