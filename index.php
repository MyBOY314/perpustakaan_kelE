        ...
        <div class="container min-vh-100 d-flex align-items-center">
            <div class="pt-10 mt-6">
                <h2 class="text-center align-middle text-white"><b>
                        Perpustakaan Kelompok E</b></h2>
                        <div style="height:100%; position:relative;">
                <div style="height:10%; position:absolute; bottom:0px; color:white" >Keterangan :
                    jangan lupa untuk import database, karena database kami tidak sama seperti contoh !!</div>
            </div>
            </div>
